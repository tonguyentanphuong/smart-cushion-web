          ...
          >
            <div className="relative w-full h-full flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20">
              <div className="flex flex-col items-center gap-6 lg:gap-10">
                <div className="w-[45vh] h-[45vh] lg:w-[60vh] lg:h-[60vh] rounded-[2.5rem] lg:rounded-[4rem] bg-neutral-950/80 border-2 border-white/10 p-4 flex items-center justify-center backdrop-blur-sm shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative group">
                  <div className="absolute inset-0 rounded-[2.5rem] lg:rounded-[4rem] border border-primary/20 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
                  
                  {/* Glowing background mesh coordinates grid */}
                  <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff03_1px,transparent_1px),linear-gradient(to_bottom,#ffffff03_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none rounded-[2.5rem] lg:rounded-[4rem]" />
